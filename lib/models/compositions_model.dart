...
class CompositionModel {
    ...
    int? totalProtiens;
    int? albumin;
    int? albuminAndGlobulinRatio;

    CompositionModel({this.age, this.gender, this.totalBilirubin, this.directBilirubin, this.alkalinePhosphotase, this.alamineAminotransferase, this.aspartateAminotransferase, this.totalProtiens, this.albumin, this.albuminAndGlobulinRatio});
